...
### Changed
- Synchronize full 52-page documentation site, responsive diagrams, instant search & delivery runs 088-103
...
### Changed
- Establish clean starter devflow workspace and empty directory hygiene

## [2.17.2] - 2026-09-11

### Changed
- Rollback to feature 087 with legacy DevFlow 3-pillars structure
...
### Changed
- Shorten third-party skill installation commands to npx nexus-devflow

## [2.16.1] - 2026-09-09

### Changed
- Release v2.16.1: Standardize Paper/Ink light theme playbooks, Thai diagram typography & English agent prompts

## [2.16.0] - 2026-09-09

### Changed
- Release v2.16.0: Unscoped CLI packages (nexus-devflow & create-nexus-devflow), Ponytail YAGNI skill & third-party recommendations

## [2.15.3] - 2026-09-08

### Changed
- Release v2.15.3: Implement Archify diagramming tool, offline font embedding & repository evidence validation

## [2.15.2] - 2026-09-08

### Changed
- Consolidate 9arm-skills into DevFlow core (/debug, /audit, /status, /complete) & purge extension (#082)

## [2.15.1] - 2026-09-08

### Changed
- Release v2.15.1: Purge Matt Pocock vendor, unify debug skill & support headless ticket ingestion (#081)

## [2.15.0] - 2026-09-07

### Changed
- Release v2.15.0: Modernize Web Dashboard with Dynamic Archify Visualizer, Recommended Skills & Playwright Test Harness
...
### Changed
- Release v2.13.0: Consolidate 6 Deep Architectural Engines (ADR-0001 - ADR-0006) and Matt Pocock AI-Engineering Flows
...
### Changed
- Prune studio reference artifacts and cleanup reference directory (069)
...
### Changed
- Release v2.10.3: Standardize BugHunter skill instructions to English with [devflow] prefix and central config artifact integration

## [2.10.2] - 2026-09-01

### Changed
- Release v2.10.2: Bundle BugHunter master skill as 31st Core Skill with pre-flight check and graceful knowledge base installation guidance

## [2.10.1] - 2026-09-01

### Changed
- Release v2.10.1: BugHunter master skill, compound vendor sync engine, and 9arm-skills suite refresh
