...
- `.agents/skills/` (33 Core Skills for Google Antigravity, OpenAI Codex, Cursor, Copilot)
- `.claude/skills/` (33 Core Skills for Claude Code)
...
The 33 names come from the canonical bundled inventory. Local or Personal Skills
