...
description: |
  ...
  Answers questions regarding code structure, logic (Document what IS) citing line by line.
...
**Path**: `.workspaces/research/research-{topic-slug}.md`
...
**Document**: `.workspaces/research/{filename}.md`
