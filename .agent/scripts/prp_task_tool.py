...
from prp_core import (
    ...
    get_template, normalize_to_template, validate_against_template, ensure_dirs
)
...
def cmd_init(args):
    ...
    # 6. spec.md (Simple creation from template if needed, or just touch)
    spec_path = task_dir / "spec.md"
    if not spec_path.exists():
        with open(spec_path, 'w', encoding='utf-8') as f:
            f.write(f"# Spec: {args.id} - {args.title}\n\n{args.description or 'Generated by PRP Tool.'}\n")
