---
description: Invoke Agent - Run a specific specialist agent persona on the codebase or a specific file for targeted expertise.
---
...
Example: `/90-Agent code-simplifier src/utils.ts`
Example: `/90-Agent silent-failure-hunter src/services/`
...
3.  **Output**
    ...
    - If the agent produces a report, save it to `.workspaces/reports/{AGENT_NAME}_{TIMESTAMP}.md` (or print to chat if short).
