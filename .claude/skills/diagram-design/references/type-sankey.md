...
- **No arrowheads, ever.** Direction is implied by the left-to-right column order. This is a deliberate, explicit exemption from [section 6](svg-primitives.md)'s orthogonal-elbow-and-arrowhead rule: ribbons are area encodings, not connectors, and a marker on a filled band reads as clutter, not information.
