...
```text
/discovery "Migrate user authentication to OAuth2 & ThaID"
/10-define
/20-spec
/30-plan
/40-execute
...
### Lifecycle Walkthrough:
1. **`/discovery`**: Explores problem space, evaluates feasibility, and records Go/No-Go decision in `devflow/discoveries/DISC-xxx/discovery.md`.
