...
> Living context artifact generated by `scripts/overview.ts` on 2026-09-11T10:06:02.537Z.
...
- **Feature**: Decade-Numbered Folder Architecture, Legacy Path Resolver & Structure Migration Engine
- **Feature**: AI-Orchestrated Project-Local Vendor Skill Ingestion (`/vendor`, `skill-add`, `equip`, `ingest`)
- **Feature**: Upstream AI Blueprint v1.6.1 Synchronization (Installer Security, Completion Recovery, Build History, Local-Only Review & Status Alignment)
