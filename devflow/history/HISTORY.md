...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 2026-09-03 | `070` | Feature | ซิงก์ส่วนขยาย Upstream AI Blueprint (v1.5.0 – v1.5.1) — Hardened Run-State Engine & On-Demand Context Loading (`DISC-20260903-001`) | `cc1bbe0` | `Released` | [`070-sync-upstream-ai-blueprint-v150-v151.md`](features/070-sync-upstream-ai-blueprint-v150-v151.md) |
| 2026-09-02 | `069` | Feature | Standalone HTML Report Diagram Integration & Skill Auto-Install (`DISC-20260902-003`) | `a7e9707` | `Released` | [`069-report-html-diagram-integration.md`](features/069-report-html-diagram-integration.md) |
