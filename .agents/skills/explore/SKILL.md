...
plan, or treat missing DevFlow context as a blocker to discussing the idea.
This command never writes activity state, including `devflow/.state/run.json`.
