...
### 10. `nexus-devflow uninstall` / `eject` (Terminal CLI)
- **หน้าที่**: ถอนการติดตั้งและลบไฟล์ DevFlow ทั้งหมดออกจากโปรเจกต์อย่างหมดจด (Clean Eject) สำหรับเตรียมส่งมอบงานหรือทำ Open-Source โดยไม่แตะต้องซอร์สโค้ดของแอปพลิเคชัน
- **การใช้งาน**: `npx @jakkrichm/create-nexus-devflow uninstall [-y]` หรือ `npx @jakkrichm/create-nexus-devflow eject [--dry-run]`
