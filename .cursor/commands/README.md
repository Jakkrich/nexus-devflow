...
The Markdown files in this folder are **Custom Commands** to be used in Cursor Chat, designed around the principles of **Context Engineering** and **System-Agentic Development** so that the AI can tackle complex tasks systematically.
...
- `*.md`: Main command files that appear when typing `/` into the chat box.
- All commands here act as an **Orchestrator** to call Specialized Agents in the `.cursor/agents/` folder.
...
| **Templates** | `.cursor/PRPs/templates/` | `Internal` | Data structure prototype files (JSON, Markdown) |
