...
flowchart TD
    ...
    subgraph CDL ["⚡ Canonical Development Lifecycle (กระบวนการพัฒนาหลัก - Main Branch)"]
        ...
        Human["/34-Human<br/>Maintainer Review<br/>(การรีวิวและอนุมัติความเปลี่ยนแปลงโดยเจ้านาย)"]
...
*   **Pipeline Delta (Revision & Feedback Loop - ลูปการปรับปรุงตามความเห็นผู้รีวิว)**: หากเจ้านายมีคำแนะนำเพิ่มเติมในขั้นตอนตรวจรับงาน (`/34-Human`) ระบบจะส่งกลับไปปรับปรุงแผนงานผ่าน `/35-Followup` เพื่อแก้ไขแผนงานและอัปเดตสเปกใหม่ที่ขั้นตอน `/31-Plan` ป้องกันปัญหาการพัฒนาโค้ดหลุดขอบเขตความต้องการ
...
เจ้านายสามารถใช้คำสั่ง `/05-Goal` เมื่อต้องการให้เอเจนต์หลักทำหน้าที่เลือกเวิร์กโฟลว์พัฒนาที่เหมาะสมที่สุด จัดสรรส่งงานให้เอเจนต์เฉพาะทาง ควบคุมงบประมาณ Tokens และจัดทำสรุปรายงานการบันทึกการตัดสินใจทางสถาปัตยกรรมก่อนส่งมอบเข้าลูปกระบวนการพัฒนาหลัก
...
flowchart TD
    ...
    Human["/34-Human<br/>เจ้านายและผู้ดูแลร่วมรีวิวอนุมัติ"]
...
เจ้านายสามารถเข้าทำงานตามลูปกระบวนการพัฒนาหลักนี้ได้โดยตรงหากมีความต้องการและเป้าหมายที่ชัดเจนอยู่แล้ว เช่น การเพิ่มฟีเจอร์ใหม่ที่ขอบเขตชัดเจน การแก้ไขบั๊กทั่วไป หรือการทำแบบทดสอบ Unit Test เพิ่มเติม
...
flowchart TD
    ...
    Human["/34-Human<br/>(เจ้านายและผู้ดูแลรีวิวการส่งมอบงาน)"]
...
ในกระบวนการทำงานร่วมกับ AI-enabled IDE อย่าง Antigravity เจ้านายไม่จำเป็นต้องเรียกใช้คำสั่งระดับต่ำหรือจัดการประวัติการเปลี่ยนแปลงด้วยตนเอง เจ้านายเพียงแค่ระบุเป้าหมายระดับสูงที่ต้องการในช่องแชทโดยตรง จากนั้นระบบจัดสรรเวิร์กโฟลว์เอเจนต์ DVA จะคัดกรอง วางแผน และรันเครื่องมือประมวลผลงานเบื้องหลังทั้งหมดโดยอัตโนมัติ
...
หรือระบุคำสั่งควบคุมเวิร์กโฟลว์เฉพาะเจาะจงโดยตรงเมื่อเจ้านายประเมินขอบเขตของงานและหมายเลขหน้างานย่อยได้แล้ว:
...
ระบบจะรันเวิร์กโฟลว์เบื้องหลังและอัปเดตสถานะให้โดยอัตโนมัติ ทั้งการบันทึกประวัติลอจิกในเอกสาร Artifacts การรันระบบประเมินความถูกต้องของโค้ด และการจัดเก็บข้อมูล Session Log เจ้านายสามารถเข้าดูสารบัญรายละเอียดประโยคสั่งการและกรณีศึกษาเพิ่มเติมได้ที่ [USAGE.md](./USAGE.md)
...
เจ้านายสามารถเข้าศึกษาตัวอย่างและรายการคำสั่งประมวลผลทั้งหมดแบบละเอียดได้ที่ [USAGE.md](./USAGE.md)
...
เจ้านายสามารถระบุเรียกใช้งานเอเจนต์ย่อยเฉพาะทางได้โดยตรงเมื่อต้องการตรวจสอบเป้าหมายใดๆ ผ่านข้อความสั่งการในช่องแชท:
```text
