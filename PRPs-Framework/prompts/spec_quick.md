...
- `implementation_plan.md` - Simple plan with 1-2 subtasks
...
You MUST use the Write tool to save the plan.
...
```bash
# Check files exist
ls -la spec.md implementation_plan.md
...
Read the task, create the minimal spec.md and implementation_plan.md.
