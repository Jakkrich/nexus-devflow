...
**Inputs**:
- `requirements.md` - User requirements with mentioned integrations
...
Identify from the requirements.md:
...
### [Integration Name]
- **Package**: [package] ([install command])
- **API Patterns**:
    - **Imports**: [list]
...
Start by reading requirements.md, then research each integration mentioned.
