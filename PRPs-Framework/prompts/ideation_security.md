...
If `graph_hints.md` exists and contains hints for your ideation type (`security_hardening`), use them to:
...
Write your findings to `{output_dir}/security_hardening_ideas.md`:
