...
- `project_index.md` - Project structure (optional, may be in spec dir or auto-claude dir)

**Output**: `complexity_assessment.md` - Structured complexity analysis

You MUST create `complexity_assessment.md` with your assessment.
...
Create `complexity_assessment.md`:

```bash
cat > complexity_assessment.md << 'EOF'
...
## Analysis
- **Scope**: [Estimated files/services involved]
- **Integrations**: [External services/dependencies]
- **Infrastructure**: [Docker/DB changes needed]
...
Add this `validation_recommendations` section to your `complexity_assessment.md` output:
...
1. **ALWAYS output complexity_assessment.md** - The orchestrator needs this file
...
1. Read `requirements.md` to understand the full task context
2. Analyze the requirements against all assessment criteria
3. Create `complexity_assessment.md` with your assessment
