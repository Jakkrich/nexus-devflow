...
[test commands from project_index.md]
...
Update `implementation_plan.md` to signal fixes are complete:

Add a note in the `## QA Sign-off` section that fixes have been applied and it's ready for re-validation.
