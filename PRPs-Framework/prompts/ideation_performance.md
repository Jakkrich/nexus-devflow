...
If `graph_hints.md` exists and contains hints for your ideation type (`performance_optimizations`), use them to:
...
Write your findings to `{output_dir}/performance_optimizations_ideas.md`:
