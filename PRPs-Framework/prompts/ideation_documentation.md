...
If `graph_hints.md` exists and contains hints for your ideation type (`documentation_gaps`), use them to:
...
Write your findings to `{output_dir}/documentation_gaps_ideas.md`:

```markdown
# Documentation Gaps Ideas

## [doc-001]: [Title]
- **Category**: [category]
- **Priority**: [priority]
- **Affected Areas**: [Area1, Area2]
- **Current Documentation**: [Description]
- **Proposed Content**: [Description]
- **Effort**: [effort]
```
