...
const CUSTOM_DESCRIPTIONS = {
  ...
  'goal': '[Devflow] High-level goal routing and open-ended request intake before entering the 00-explore stage.',
  ...
  '00-explore': '[Devflow] Discover stage in DevFlow 2.0 - explore a request, route supporting inquiry, and decide whether delivery work should begin without allocating a running ID.',
